...
public partial class Page03View : UserControl
{
  public Page03View()
  {
    InitializeComponent();
  ...
  public static readonly DependencyProperty FileDropCommandProperty = DependencyProperty.Register("FileDropCommand", typeof(ICommand), typeof(Page03View), new PropertyMetadata(null)); public ICommand FileDropCommand { get => (ICommand)GetValue(FileDropCommandProperty); set => SetValue(FileDropCommandProperty, value); }
