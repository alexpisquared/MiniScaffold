...
public partial class NavBarVM : BaseMinVM
{
    ...
    public NavBarVM(SrvrNameStore SrvrNameStore, DtBsNameStore DtBsNameStore, GSReportStore gsr, LetDbChgStore letDStore, Page00NavSvc page00NavSvc, Page01NavSvc page01NavSvc, Page02NavSvc page02NavSvc, Page03NavSvc page03NavSvc, Page04NavSvc page04NavSvc, Page05NavSvc Page05NavSvc, Page06NavSvc Page06NavSvc, EmailDetailNavSvc emlDtlNavSvc, UserSettings usrStgns)
    {
        ...
        NavigatePage06Command = new NavigateCommand(Page06NavSvc);
    ...
    bool _awd; public bool LetDbChg
    {
        get => _awd; set
        {
            if (SetProperty(ref _awd, value)) { UsrStgns.LetDbChg = value; __letDbChStore.Change(value); }
        }
    }
    ...
    public ICommand NavigatePage00Command
    {
        get;
    }
    public ICommand NavigatePage01Command
    {
        get;
    }
    public ICommand NavigatePage02Command
    {
        get;
    }
    public ICommand NavigatePage03Command
    {
        get;
    }
    public ICommand NavigatePage04Command
    {
        get;
    }
    public ICommand NavigatePage05Command
    {
        get;
    }
    public ICommand NavigatePage06Command
    {
        get;
    }
    public ICommand NavigateEmlDtlCommand
    {
        get;
    }
